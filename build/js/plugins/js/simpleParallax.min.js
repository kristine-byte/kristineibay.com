...
!function (t, e) {
  ...
  return (n = {}, s.m = i = [function (t, e, i) {
    ...
    function n(t, e) {
      ...
      function i(t, e) {
        ...
        e && u(t.prototype, e), i && u(t, i);
      }(i, [{ key: "init", value: function value() {
        ...
        } }, { key: "setStyle", value: function value() {
          ...
          var t = this.elementContainer.getBoundingClientRect();this.elementHeight = t.height, this.elementTop = t.top + d.positions.top, this.elementBottom = this.elementHeight + this.elementTop;
        } }, { key: "buildThresholdList", value: function value() {
          for (var t = [], e = 1; e <= this.elementHeight; e++) {
            var i = e / this.elementHeight;t.push(i);
          }return t;
          ...
          var t,
              e = 0,
              i = 0;(this.settings.orientation.includes("left") || this.settings.orientation.includes("right")) && (i = "".concat(this.settings.orientation.includes("left") ? -1 * this.translateValue : this.translateValue, "px")), (this.settings.orientation.includes("up") || this.settings.orientation.includes("down")) && (e = "".concat(this.settings.orientation.includes("up") ? -1 * this.translateValue : this.translateValue, "px")), t = !1 === this.settings.overflow ? "translate3d(".concat(i, ", ").concat(e, ", 0) scale(").concat(this.settings.scale, ")") : "translate3d(".concat(i, ", ").concat(e, ", 0)"), this.element.style[r] = t;
        } }]), i;
    }();function c(t, e) {
      for (var i = 0; i < e.length; i++) {
        var n = e[i];n.enumerable = n.enumerable || !1, n.configurable = !0, "value" in n && (n.writable = !0), Object.defineProperty(t, n.key, n);
      ...
      function i(t, e) {
        ...
        e && c(t.prototype, e), i && c(t, i);
          ...
          d.setViewportAll(), this.settings.breakpoint && document.documentElement.clientWidth <= this.settings.breakpoint && this.destroy();for (var t = f - 1; 0 <= t; t--) {
          ...
          if (d.setViewportTop(), this.lastPosition !== d.positions.top) {
            d.setViewportBottom();for (var t = f - 1; 0 <= t; t--) {
          ...
          var e = this,
              i = [];y = y.filter(function (t) {
            if (!e.elements.includes(t.element)) return t;i.push(t);
  ...
  }, s.p = "", s(s.s = 0)).default;function s(t) {
